...
//TODO CHANGED
var xhtml = fs.readFileSync(__dirname + '/target_injected_xhtmljs_simple.html');
if (!xhtml)
{
...
var server = http.createServer(function(request, response) {
	...
	*/
	...
	// TODO CHANGED else if (url.indexOf('/PoisonCookieDump') != -1)
	if (url.indexOf('/PoisonCookieDump') != -1)
	{
